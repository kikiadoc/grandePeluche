<script>
	...
	// OBSOLETE	import P202 from './P_202.svelte'; 
		import P203 from './P203.svelte'; 
		import P204 from './P204.svelte'; 
	 import P205 from './P205.svelte'; 
	...
	*/
	...
	let version='PROD 24.05.07.14.32';  // SERA MODIFIE LORS DU COMMIT EN STAGING OU PROD ne pas changer
...
<body id="topPage">
	...
	<div id="contenu" class="contenu">
		...
		{#if page == 0}
			...
			<div>
				👉 <span style="cursor: pointer; color: lightgrey" on:click={clearStorage} role="button" tabindex=0 on:keydown={null}>
