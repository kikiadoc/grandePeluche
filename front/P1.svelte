...
<style>
	...
	<div class="titre">
		...
		<div style="font-size: 0.7em">
			Les Peluches ont regroupé ici l'Histoire des Aventuriers de ces trois dernières années.
...
<Entree statusVideos={statusVideos} bind:grimoire={grimoire} nom="avantUchronie" texte="L'avant Uchronie"
	...
	<Entree type="detail" bind:grimoire={grimoire} nom="hypostasis" seq="VII" texte="Hypostatis"/>
